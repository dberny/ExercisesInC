...
named `cards.c`.  I recommend Atom, but some people like Sublime Text.
...
It adds more sections to the assembly code although I can't really tell what
those parts do.
...
I don't see any effect on the printing either way
...
The optimization did not add 1 to y, so it printed 5 instead of 6. This tells me
that it looks only at the first assignment to make y = x.
